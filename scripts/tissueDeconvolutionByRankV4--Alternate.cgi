...
#my $heatmap_chosen = !exists($raw_user_input{"matrix"});
#if ($heatmap_chosen) {
    ...
    my %full_to_abbrev;
    open my $abbrevs_file, '<', '/UCSC/Pathways-Auxiliary/UCLApathways-Larry-Execs/SigByRank/abbrevs_fixed.txt' or die "file not found$!";
    ...
    my $null_metric = $raw_user_input{'null_metric'} eq 'checked' ? 'checked' : 'none';
